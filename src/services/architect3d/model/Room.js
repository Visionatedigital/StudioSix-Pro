...
import {EventDispatcher, Vector2, Vector3, BufferGeometry, BufferAttribute, Shape, ShapeGeometry, Mesh, MeshBasicMaterial, DoubleSide, Box3} from 'three';
...
//		this.floorChangeCallbacks.fire();
	...
	generateRoofPlane()
	{
		...
		this.corners.forEach((corner) => {
			vertices.push(corner.x, corner.elevation, corner.y);
		});

		// Create triangular faces (fan triangulation from first vertex)
		for (var i = 2; i < this.corners.length; i++)
		{
