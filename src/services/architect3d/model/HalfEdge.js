import {EventDispatcher, Vector2, Vector3, Matrix4, Mesh, BufferGeometry, BufferAttribute, MeshBasicMaterial, Box3} from 'three';
...
export class HalfEdge extends EventDispatcher
{
	...
	generatePlane()
	{
		...
		var vertices = new Float32Array([
			...
			v2.x, v2.y, v2.z,  // 1
			v3.x, v3.y, v3.z,  // 2
			v1.x, v1.y, v1.z,  // 3 (repeat v1)
			v3.x, v3.y, v3.z,  // 4 (repeat v3)
			v4.x, v4.y, v4.z   // 5
		]);
